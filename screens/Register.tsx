  ...
  return (
    <KeyboardAvoidingView behavior='padding' style={styles.container}>
      <ImageBackground source={require('../assets/back.png')} resizeMode='stretch' style={styles.container}>
        <Text style={styles.titulo2}>CADASTRO DE PRESTADOR</Text>
        
         <View style={styles.TabInput}>
           <TouchableOpacity style={styles.buttonTab1} onPress={() => navigation.replace('Register2')}>
            <Text style={styles.buttonTextTab2}>Contratante</Text>
          </TouchableOpacity>
           <TouchableOpacity style={styles.buttonTab} >
            <Text style={styles.buttonTextTab}>Prestador</Text>
          </TouchableOpacity>
         </View>
